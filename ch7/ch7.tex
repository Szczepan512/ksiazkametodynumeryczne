...
\end{equation}
\paragraph*{P7.1}
	\marginpar{\includegraphics[width=\marginparwidth]{fig71}\captionof{figure}{Diffusion of the $n=$ 1 sine temperature distribution given in Problem 7.1(a).}\label{fig:32}}
...
\end{enumerate}
	\marginpar{\includegraphics[width=\marginparwidth]{fig72}\captionof{figure}{Diffusion of the Gaussian temperature distribution given in Problem 7.1 (c) with insulating boundary conditions.}\label{fig:32}}
