...
−i Et/ħ}$
and plug this
into Eq. \ref{eq:49}, we find the time-independent Schrödinger equation
...
Let\rq s practice this procedure for the problem at hand.
	...
	\begin{problem} \label{P4.3}  Substitute $x = \alpha \xi$ into Eq. \ref{eq:411}, and then do some algebra to put the
