...
\paragraph*{P9.4} Write a program that accepts a value of $\omega$ and runs the iteration in Eq. \eqref{eq:912}.
...
\paragraph*{P9.6}
	\marginpar{\includegraphics[width=\marginparwidth]{fig92}\captionof{figure}{The potential $V(x, y)$ rom Problem 9.6(a).}\label{fig:44}}
		\marginpar{\includegraphics[width=\marginparwidth]{fig93}\captionof{figure}{The potential $V(x, y)$ with zero-derivative boundary conditions on two sides (Problem 9.6(b).)}\label{fig:45}}
